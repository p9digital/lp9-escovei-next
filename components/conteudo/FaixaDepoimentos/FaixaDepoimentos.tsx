  ...
  const modelos = [
    {
      ...
      subheader: "Na Escovei, você não precisa ser dentista para entrar no nosso time!<br /><strong>Confira o depoimento do franqueado Luiz Nieto:</strong>",
      foto: "/images/faixa-depoimentos/foto-depointe1.png",
      fotoSize: { height: "150", width: "150" },
      depoimento: "Sou franqueado Escovei há 5 anos e possuo 9 unidades em andamento. Eu não sou dentista, sou administrador de empresas e meu sócio é dentista.”",
      video: "https://www.youtube.com/embed/rtt833rVfQg",
      caption: "<strong>Luiz Nieto</strong> - franqueado Escovei e administrador de empresas - Estado de SP",
    },
    {
      id: 2,
      header: "Já tem um consultório, mas busca uma solução para <strong>melhorar a gestão e o faturamento?</strong>",
      subheader: "<strong>Confira o que nosso franqueado Felipe diz sobre a Escovei:</strong>",
      foto: "/images/faixa-depoimentos/foto-depointe2.png",
      fotoSize: { height: "150", width: "150" },
      depoimento: "Possuo 32 unidades em funcionamento e 10 em implantação. O principal motivo de eu ter entrado na Escovei foi o negócio já com processos formados.”",
    ...
    },
    {
      ...
      subheader: "Transforme vidas através do sorriso com a sua franquia Escovei, <strong>confira<br />o depoimento de Luiz Felipe:</strong>",
