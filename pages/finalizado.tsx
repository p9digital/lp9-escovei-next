        ...
        <FaixaTextos style={{ minHeight: "calc(100vh - 525px)" }}>
          ...
          <LinkWrapper>
            <LinkDownload
              ...
              center="center"
              href={
                `https://wa.me/${leadNome.donoLead.link}/?text=${encodeURI(`[Escovei] Olá, sou ${leadNome ? leadNome.nome.split(' ')[0] : ''} e quero saber mais sobre a franquia Escovei.`)}`
              }
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <FaixaWrapperRedes>
        <FaixaTextos>
          <TitleFinalizado fontColor="white" margem="0 0 5rem">
            SIGA A <strong>Escovei</strong> NAS REDES SOCIAIS:
          </TitleFinalizado>

          <RedesWrapper>
            <a
              href="https://www.facebook.com/escovei.br "
              target="_blank"
              rel="noreferrer"
            >
              <Icon
            ...
            <a
              href="https://www.instagram.com/_escovei"
              target="_blank"
              rel="noreferrer"
            >
              <Icon
          ...
          <br />
          <RedesWrapper>
            <a href="https://escovei.com.br/" target="_blank" rel="noreferrer">
              <Icon
                tamanho="3.5rem"
                cor="#FFFFFF"
                icon="world"
